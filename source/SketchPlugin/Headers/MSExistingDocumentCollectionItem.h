...
- (void)exportPreviewImageForDocumentFileURL:(id)arg1 maxPixelSize:(double)arg2 handler:(id)arg3;
...
- (void)fetchPreviewImageWithMaximumPixelSize:(double)arg1 handler:(id)arg2;
