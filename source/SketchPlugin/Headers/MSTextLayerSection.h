...
- (void)changeFontPropertiesInBlock:(id)arg1;
- (void)changeFontPropertiesOfTextObjectsInBlock:(id)arg1;
...
- (void)changeParagraphStyleInBlock:(id)arg1;
- (id)textView;
...
- (void)maintainTextLayerBaselinesInBlock:(id)arg1;
...
- (void)commitHistory;
- (void)closeExistingPopoverOrShowNewOneWithContentClass:(Class)arg1 sender:(id)arg2 viewCreatorBlock:(id)arg3;
