...
+ (void)exportDocument:(id)arg1 withName:(id)arg2 includeDocument:(BOOL)arg3 toLocalURL:(id)arg4 completionBlock:(id)arg5;
+ (void)exportSelectedArtboardsOfDocument:(id)arg1 withName:(id)arg2 includeDocument:(BOOL)arg3 toLocalURL:(id)arg4 completionBlock:(id)arg5;
...
- (void)callCompletionBlock:(id)arg1 withDidExport:(BOOL)arg2 error:(id)arg3;
- (void)exportWithCompletionBlock:(id)arg1;
