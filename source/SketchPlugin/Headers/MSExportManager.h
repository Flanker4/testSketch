...
@interface MSExportManager : NSObject
{
    ...
    id _sliceCompletionBlock;
}

@property(copy, nonatomic) id sliceCompletionBlock; // @synthesize sliceCompletionBlock=_sliceCompletionBlock;
...
- (void)warnBeforeOverwritingAndSaveSlices:(id)arg1 toFolder:(id)arg2 completionBlock:(id)arg3;
