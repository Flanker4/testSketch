...
+ (double)zoomValue;
+ (void)drawWithTransformStruct:(struct _CHTransformStruct)arg1 aroundPoint:(struct CGPoint)arg2 usingBlock:(id)arg3;
+ (void)drawShadowForHover:(BOOL)arg1 inBlock:(id)arg2;
+ (id)gradient;
