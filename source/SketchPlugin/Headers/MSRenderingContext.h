...
- (void)drawSymbolMaster:(id)arg1 inBlock:(id)arg2;
...
- (void)doNotClipFillsInBlock:(id)arg1;
- (BOOL)shouldDrawFills;
- (void)ifCondition:(BOOL)arg1 skipDrawingFillsInBlock:(id)arg2;
- (void)applyLayerTransform:(id)arg1 inBlock:(id)arg2;
- (void)applySettings:(id)arg1 withOptions:(long long)arg2 inBlock:(id)arg3;
- (void)prepareLayerDrawing:(id)arg1 inBlock:(id)arg2;
...
- (void)transparencyLayerInRect:(struct CGRect)arg1 inBlock:(id)arg2;
- (void)transparencyLayerInBlock:(id)arg1;
- (void)transparencyLayerInRect:(struct CGRect)arg1 mayOptimise:(BOOL)arg2 inBlock:(id)arg3;
- (void)cancel;
- (id)popParentGroup;
...
- (id)cachedValueForModelObject:(id)arg1 key:(id)arg2 zoomIndependent:(BOOL)arg3 orCreateWithBlock:(id)arg4;
- (void)dealloc;
- (void)tearDown;
- (BOOL)hasGraphicsContext;
- (id)CIContextWithSoftwareRenderer:(BOOL)arg1;
- (void)setUp;
- (void)renderInBlock:(id)arg1;
