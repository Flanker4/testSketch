...
- (void)selfIntersectingEdgesWithBlock:(id)arg1;
- (void)intersectingEdgesWithBlock:(id)arg1;
- (id)previousCrossing:(id)arg1;
- (id)nextCrossing:(id)arg1;
- (void)crossingsCopyWithBlock:(id)arg1;
- (void)crossingsWithBlock:(id)arg1;
...
- (void)intersectionsWithBezierCurve:(id)arg1 overlapRange:(id *)arg2 withBlock:(id)arg3;
