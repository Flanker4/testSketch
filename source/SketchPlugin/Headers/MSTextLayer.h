...
+ (void)maintainTextLayerBaselinesForLayers:(id)arg1 inBlock:(id)arg2;
...
- (void)ignoreDelegateNotificationsInBlock:(id)arg1;
@property(copy, nonatomic) NSString *stringValue;
- (void)updateAttributedStringInBlock:(id)arg1;
