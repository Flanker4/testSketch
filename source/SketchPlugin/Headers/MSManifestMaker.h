...
+ (id)manifestForDocument:(id)arg1 withName:(id)arg2 selectiveExport:(BOOL)arg3 usePageIfMissingArtboard:(BOOL)arg4 imageProviderBlock:(id)arg5;
...
@property(copy, nonatomic) id imageProviderBlock; // @synthesize imageProviderBlock=_imageProviderBlock;
