...
#import "MSPage-Protocol.h"
#import "MSRootLayer-Protocol.h"
@protocol MSCloudExportable, MSSimpleGrid, MSRulerData, MSLayoutGrid ;
@class MSArtboardGroup, MSLayoutGrid, MSRulerData, MSSimpleGrid, NSArray, NSDictionary, NSObject, NSString;
...
+ (void)enumerateExportableLayersWithPage:(id)arg1 block:(id)arg2;
+ (id)page;
