...
@property(copy, nonatomic) id tileRenderingCompletion; // @synthesize tileRenderingCompletion=_tileRenderingCompletion;
...
- (void)observeRenderingOfTiles:(id)arg1 completion:(id)arg2;
...
- (void)refreshOverlayWithBlock:(id)arg1;
