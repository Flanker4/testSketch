...
- (id)document;
- (id)currentArtboard;
- (void)hasDocumentStructureChangedWithCompletionBlock:(id)arg1;
...
- (void)renderImageForArtboardIdentifier:(id)arg1 inRect:(struct CGRect)arg2 scale:(double)arg3 context:(id)arg4 handler:(id)arg5;
