...
#import "MSLayerManipulation-Protocol.h"
#import "MSRectDelegate-Protocol.h"


@class MSAbsoluteRect, MSStyledLayer, NSDictionary, NSMenu, NSObject, NSString;
...
- (id)containedLayers;
- (void)followMaskChainForLayerAtIndex:(unsigned long long)arg1 usingBlock:(id)arg2;
